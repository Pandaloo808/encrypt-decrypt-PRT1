...
def startEncryption():
    ...
    btn_create = Button(encryption_window,command=saveData, text="Create",bg="crimson", font = 'arial 13',releif=FLAT)
...
btn_start_encryption = Button(root, text="Start Encryption", bg="crimson" , font =('arial', 13) , command=startEncryption, relief=FLAT)
btn_start_encryption.place(relx=0.3,rely=0.6, anchor=CENTER)

btn_start_decryption = Button(root, text="Start Decryption" , bg="crimson", font = 'arial 13' ,  command=startDecryption,relief=FLAT)
